        ...
        <nav className="flex items-center gap-2">
          {authenticated ? (
            <>
              <Link
                to="/dashboard"
                className="hidden rounded-md px-3 py-1.5 text-sm font-medium text-foreground hover:bg-muted sm:inline-block"
            ...
            <>
              <Link to="/auth" className="rounded-md px-3 py-1.5 text-sm font-medium hover:bg-muted">
                Sign in
              </Link>
              <Link to="/auth" className="rounded-md bg-primary px-4 py-1.5 text-sm font-medium text-primary-foreground shadow-card hover:opacity-90">
                Get started
              </Link>
            </>
          )}
